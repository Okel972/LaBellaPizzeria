<?php
    ...
    // Récupération de la catégorie de produits depuis l'URL (s'il existe)
    ...
    if ($category) {
        ...
        $select_products->bindParam(1, $category, PDO::PARAM_STR);
    }
...
<html lang="fr">
    ...
    <body>
        ...
        <?php
            ...
            // Définition du titre de la catégorie en fonction de la catégorie sélectionnée ou par défaut
            $categoryTitle = isset($_GET['category']) ? ucfirst($_GET['category']) : 'Nos Articles';
